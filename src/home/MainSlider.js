        ...
        <section className="Hero">
            <div className="Hero__container">     
                <div className="Hero__slide">
                    ...
                    {slides && 
                        <Carousel className="Hero__carousel" infiniteLoop={true} showThumbs={false} autoFocus={true} autoPlay={true} interval={5000} transitionTime={1000}>
                            {slides?.map(slide => (
                                <div className="Hero__carouselItem" key={slide.id} style={{backgroundImage: `url(${slide.url})`}}></div>
                            ))}                     
                        </Carousel>}
                        ...
                        <div className="Hero__sliderText">
                            <h2>NEW MODEL</h2>
                            <p>Manticora</p>
                            <Link className="Hero__sliderLink" to={`/products/bikesPreview/1`}>Check It Now</Link>
